...
// todo: integrar com site
// todo: armazenar em localStorage
// todo: restringir valores inválidos de validade (?)
// todo: adicionar mais parâmetros de pesquisa()
// todo: adicionar imagem
// todo: valor inicial
// todo: isComprado (?)
// todo: subclasse Venda.js, cria objetos produtos vendidos, retira objeto do estoque
// todo: subclasse Compra.js, cria objetos quando prduto é comprado, insere no estoque
// todo: função de escrever tabela de produtos ou uma linha com o obj corrente

class Produto {
  static valorEmEstoque; // valor (R$) do estoque inteiro
  static arr_ProdutosEmEstoque; // array com os produtos em estoque
  
  constructor(desc,qtd,vUn,cod,ctg,vld,loc) {
  ...
  destroy() {  // Remover produto da lista do estoque
    ...
    this._dataRg = new Date(); //data de modificação do produto
